...
The proposed solution is based on a modular cloud architecture with loosely coupled services, enabling reuse and evolution through APIs, and supporting the 
