...
<br><br>However, the proposed formulation allows the weights to be adjusted according to the application context, program objectives, or expert-defined 
...
<br><br>Figure 5 shows the GII for Community 01 (to improve readability, the Supersystem, System, Activity Hours, and Activities columns were omitted). 
