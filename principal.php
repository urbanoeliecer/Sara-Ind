...
$link = conectarse();
session_start(); ?>
<html><head><meta><title>SaraII - Indicadores de gestión Comunitaria Rural</title></head><body>
<?php
    ...
    <?php // if (isset($_SESSION['rol']) && $_SESSION['rol'] === 'admin'): ?>
      <li>
        <ul>
          ...
          <li><a href="admin/indInterGnrl.php">Ind. de Intervención Detalle</a></li>
          <li><a href="admin/infGrafElem.php">Inf. Graf. Elementos por JAC</a></li>
          <li><a href="admin/infTabMesActivPryMVC.php">Inf. Mensual de Actividades</a></li>
        </ul>
      </li>
    <?php //endif; ?>
  </ul>
